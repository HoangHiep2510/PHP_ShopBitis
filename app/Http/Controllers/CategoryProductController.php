...
use Session;
use DB;
use Illuninate\Support\Facades\Redirect;
session_start();
...
class CategoryProductController extends Controller
{
    ...
    public function save_category_product(Request $request){
        ...
        $data['category_size'] = $request -> category_product_size;
        $data['category_color'] = $request -> category_product_color;
        $data['category_price'] = $request -> category_product_price;

        $request = DB::table('tbl_category_product') -> insert($data);
        Session::put('message','Bạn đã thêm sản phẩm thành công !!! ');

        return redirect('/XemSP');
    }
    ...
    public function update_category_product(Request $request, $category_product_id){
        ...
        $request = DB::table('tbl_category_product') -> where('category_id', $category_product_id) -> update($data);
    ...
    public function delete_category_product(Request $request, $category_product_id){
        ...
        Session::put('message','Bạn đã xoá sản phẩm thành công !!! ');
